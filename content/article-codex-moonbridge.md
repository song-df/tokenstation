...
上周我用 Codex CLI 对接自己搭的 AI 网关（t.wiselink.cc），配置填好，回车——
...
| `t.wiselink.cc/v1/responses` | ❌ 404 |
| `t.wiselink.cc/v1/chat/completions` | ✅ 200（Chat Completions 正常） |
| `t.wiselink.cc/v1/messages` | ✅ 200（Anthropic Messages 正常） |
...
*利益相关：本文提到的 T粒加油站（t.wiselink.cc）和 Moonbridge 均为作者自建/参与的项目。*

🔗 T粒加油站：https://t.wiselink.cc/
