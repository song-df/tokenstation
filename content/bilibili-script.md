...
> 「先说一下这个项目叫什么——T粒加油站（t.wiselink.cc）。」
> 
...
>
> 「Cursor 和 Continue：把 OpenAI Base URL 设成 t.wiselink.cc/v1，Key 填你的 API Key 就行。」
>
