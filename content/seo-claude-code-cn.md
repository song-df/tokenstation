...
T粒加油站（ai.aiotedu.cc）是一个国内可直接访问的 AI API 网关，支持 Anthropic 原生协议和 OpenAI 兼容协议，上线了 16 款 AI 大模型。
...
打开 https://ai.aiotedu.cc ，免费注册账号。进入个人主页，复制你的 API Key（以 `sk-` 开头）。
...
- **Cursor / Continue** — 用 OpenAI 兼容接口，Base URL 填 `https://ai.aiotedu.cc/api/v1`
...
👉 [立即注册 T粒加油站](https://ai.aiotedu.cc/)
