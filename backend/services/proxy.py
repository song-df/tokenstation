...
# ── Proxy constants ─────────────────────────────────────────────────────────
SERVER_IP = str(getattr(settings, "proxy_server_ip", "8.209.242.59"))
...
Tli_PER_QUOTA = 690  # new-api USD模式, QuotaPerUnit=500000, 1 T粒 = ¥0.01 → 690 quota
...
rules:
  ...
  - DOMAIN-SUFFIX,youtu.be,AI专线
  - DOMAIN-SUFFIX,yt.be,AI专线
  - DOMAIN-SUFFIX,withyoutube.com,AI专线
  ...
  - DOMAIN-SUFFIX,platformio.org,AI专线
  - DOMAIN-SUFFIX,contabostorage.com,AI专线
  # —— PlatformIO 嵌入式平台：ESP32 ——
  - DOMAIN-SUFFIX,espressif.com,AI专线
  - DOMAIN-SUFFIX,espressif.cn,AI专线
  # —— PlatformIO 嵌入式平台：STM32 / ARM ——
  - DOMAIN-SUFFIX,st.com,AI专线
  - DOMAIN-SUFFIX,arm.com,AI专线
  - DOMAIN-SUFFIX,os.mbed.com,AI专线
  - DOMAIN-SUFFIX,segger.com,AI专线
  - DOMAIN-SUFFIX,openocd.org,AI专线
  - DOMAIN-SUFFIX,libopencm3.org,AI专线
  # —— 通用工具链下载源 ——
  - DOMAIN-SUFFIX,sourceforge.net,AI专线
  - DOMAIN-SUFFIX,gcc.gnu.org,AI专线
  - DOMAIN-SUFFIX,cmake.org,AI专线
