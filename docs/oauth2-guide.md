...
```
GET https://t.wiselink.cc/oauth/authorize
  ?client_id=my-app
...
```bash
curl -X POST https://t.wiselink.cc/oauth/token \
...
```bash
curl https://t.wiselink.cc/oauth/userinfo \
...
引导用户到加油站注册：`https://t.wiselink.cc/register`
