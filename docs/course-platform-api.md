...
```
POST https://api.wiselink.cc/api/redeem/external/verify
...
```
POST https://api.wiselink.cc/api/redeem/external/codes
Content-Type: application/json
```
...
```
POST https://api.wiselink.cc/api/redeem/external/allocate
Content-Type: application/json
```
